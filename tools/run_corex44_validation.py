...
def unit_commands(corex_stack: str = "44") -> list[list[str]]:
    ...
    return [[*prefix, "-m", "pytest", "-q",
             ...
             "tests/unit_test/global_scheduler/test_manager.py::test_manager_v1_kv_port_stride_uses_tensor_parallel_size",
             "tests/unit_test/global_scheduler/test_manager.py::test_vllm_v1_backend_detection_is_version_independent",
             "tests/unit_test/entrypoints/vllm/test_e2e_command_utils.py",
             "tests/unit_test/entrypoints/vllm/test_v1_true_kv_migration_service_cli.py",
